 ...
 * </p>
 * <p>
 * To emulate an identified user, either use method {@link #log_in(String)} if you want to specify the user's login, or
 * method {@link #log_in()} which will do the same but using the value of {@link #DEFAULT_LOGIN} as the user's login
...
public class UserSessionRule implements TestRule, UserSession {
   ...
   */
  public UserSessionRule log_in() {
    return log_in(DEFAULT_LOGIN);
  }

  /**
   * Log in with the specified login
   */
  public UserSessionRule log_in(String login) {
   ...
   * Log in with the specified login
   */
  public UserSessionRule log_in(UserDto userDto) {
