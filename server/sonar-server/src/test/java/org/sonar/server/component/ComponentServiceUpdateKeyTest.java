...
public class ComponentServiceUpdateKeyTest {
  ...
  public void update_project_key() {
    ...
    userSession.log_in("john").addProjectUuidPermissions(UserRole.ADMIN, project.uuid());
  ...
  public void update_provisioned_project_key() {
    ...
    userSession.log_in("john").addProjectUuidPermissions(UserRole.ADMIN, provisionedProject.uuid());
  ...
  public void fail_to_update_project_key_without_admin_permission() {
    ...
    ComponentDto project = insertSampleRootProject();
    userSession.log_in("john").addProjectUuidPermissions(UserRole.USER, project.uuid());
