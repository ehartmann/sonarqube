...
public class ProvisionedActionTest {
  ...
  public void all_provisioned_projects_without_analyzed_projects() throws Exception {
    ...
    userSessionRule.log_in().addOrganizationPermission(organizationDto, GlobalPermissions.PROVISIONING);
  ...
  public void provisioned_projects_with_desired_fields() throws Exception {
    ...
    userSessionRule.log_in().addOrganizationPermission(organization, GlobalPermissions.PROVISIONING);
  ...
  public void provisioned_projects_as_defined_in_the_example() throws Exception {
    ...
    userSessionRule.log_in().addOrganizationPermission(organizationDto.getUuid(), GlobalPermissions.PROVISIONING);
  ...
  public void fail_when_not_enough_privileges() throws Exception {
    ...
    userSessionRule.log_in().addOrganizationPermission(organizationDto.getUuid(), GlobalPermissions.SCAN_EXECUTION);
