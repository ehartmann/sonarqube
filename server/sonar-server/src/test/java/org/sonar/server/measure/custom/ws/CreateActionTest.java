...
public class CreateActionTest {
  ...
  public void setUp() {
    ...
    userSession.log_in("login").setGlobalPermissions(GlobalPermissions.SYSTEM_ADMIN);
  ...
  public void create_text_custom_measure_as_project_admin() throws Exception {
    insertProject(DEFAULT_PROJECT_UUID);
    MetricDto metric = insertMetric(STRING);
    userSession.log_in("login").addProjectUuidPermissions(UserRole.ADMIN, DEFAULT_PROJECT_UUID);
