...
public class DeselectActionTest {
  ...
  public void setUp() {
    ...
    userSession.log_in("login").setGlobalPermissions(QUALITY_GATE_ADMIN);
  }
  ...
  public void project_admin() throws Exception {
    ...
    userSession.log_in("login").addProjectUuidPermissions(UserRole.ADMIN, project.uuid());
  ...
  public void fail_when_not_project_admin() throws Exception {
    ...
    userSession.log_in("login").addProjectUuidPermissions(UserRole.ISSUE_ADMIN, project.uuid());
  ...
  public void fail_when_not_quality_gates_admin() throws Exception {
    ...
    userSession.log_in("login").setGlobalPermissions(QUALITY_PROFILE_ADMIN);
