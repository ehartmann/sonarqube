...
public class SearchActionTest {
  ...
  public void setUp() {
    ...
    userSessionRule.log_in("login").setGlobalPermissions(GlobalPermissions.SYSTEM_ADMIN);
  ...
  public void search_as_project_admin() throws Exception {
    userSessionRule.log_in("login").addProjectUuidPermissions(UserRole.ADMIN, DEFAULT_PROJECT_UUID);
    MetricDto metric1 = insertCustomMetric(1);
    insertCustomMeasure(1, metric1);
