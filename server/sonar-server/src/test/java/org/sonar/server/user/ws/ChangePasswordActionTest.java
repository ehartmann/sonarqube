...
public class ChangePasswordActionTest {
  ...
  @Rule
  public UserSessionRule userSessionRule = UserSessionRule.standalone().log_in("admin").setGlobalPermissions(GlobalPermissions.SYSTEM_ADMIN);
